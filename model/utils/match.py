        ...
        for i in range(1, len(pos_list)):
            ...
            if i != len(pos_list) - 1:
                if mode == 0:  # point-wise, the last col is label_col, include label 0 and 1
                    last_col = "label"
                    #新增label信息
                    train_set.append(sample + [label_list[i]])
                ...
                test_set.append(sample + [label_list[i]])  # Note: if mode=1 or 2, the label col is useless.
